...
class OrganisationSessionSettingsIntegrationTest {
    ...
    @Autowired
    private com.nexxserve.nauth.repository.OrganisationSessionSettingsRepository settingsRepository;

    @Autowired
    private com.nexxserve.nauth.repository.OrganisationRefreshTokenRepository refreshTokenRepository;
    ...
    void refreshTtlIsAppliedToIssuedTokens() throws Exception {
        ...
        List<com.nexxserve.nauth.entity.OrganisationRefreshToken> active =
    ...
    void clientSessionOverridesTakePrecedenceOverOrgDefaults() throws Exception {
        ...
        List<com.nexxserve.nauth.entity.OrganisationRefreshToken> overrideTokens_ =
        ...
        List<com.nexxserve.nauth.entity.OrganisationRefreshToken> defaultTokens =
